package ang.neggaw.employees.exceptions;
...
/**
 * @author ANG
 * @since 06-08-2021 00:09
 */

@Order(Ordered.HIGHEST_PRECEDENCE)
@RestControllerAdvice(basePackages = {"ang.neggaw.employees.graphqls", "ang.negga.employees.restControllers"})
